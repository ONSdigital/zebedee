package com.github.onsdigital.zebedee.content.statistics.data.timeseries;
...
public class TimeSeries extends StatisticalData implements  Comparable<TimeSeries> {
    ...
    public void setCdid(String cdid) {
        if (getDescription() == null) {
            setDescription(new ContentDescription());
        }
    ...
    public String getCdid() {
        ContentDescription description = getDescription();
        if (description != null) {
