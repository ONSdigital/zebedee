...
public class CMSFeatureFlags {
    ...
    private static final String ENABLE_IDENTITY_AUTH = "ENABLE_IDENTITY_AUTH";
    ...
    private final boolean isIdentityAuthEnabled;
    ...
    private CMSFeatureFlags() {
        ...
        this.isIdentityAuthEnabled= Boolean.valueOf(getConfigValue(ENABLE_IDENTITY_AUTH));
        ...
        info().data(ENABLE_DATASET_IMPORT, isDatasetImportEnabled)
                ...
                .data(ENABLE_IDENTITY_AUTH, isIdentityAuthEnabled)
    ...
    public boolean isIdentityAuthEnabled() {
        return isIdentityAuthEnabled;
    }
