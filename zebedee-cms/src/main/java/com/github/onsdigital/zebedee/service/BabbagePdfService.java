...
public class BabbagePdfService implements PdfService {
    ...
    private static final String babbageUri = "http://localhost:8081/"; // only ever reading from local babbage instance
    ...
    public InputStream generatePdf(String uri) throws IOException {
        ...
        httpGet.addHeader("Cookie", RequestUtils.TOKEN_HEADER + "=" + session.id);
