...
public class Sessions {
	 ...
	 *
	 * @param id
	 *            The session ID in order to locate the session record.
	...
	public Session find(String email) throws IOException {
		...
		iterate: try (DirectoryStream<Path> stream = Files
	 ...
	 *
	 * @param email
	 *            The email address of the user to create a session for
