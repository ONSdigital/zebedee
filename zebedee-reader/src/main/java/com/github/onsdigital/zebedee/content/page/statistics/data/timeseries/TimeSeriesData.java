...
public class TimeSeriesData extends StatisticalData implements Comparable<TimeSeriesData> {
    ...
    public boolean equals(Object obj) {
        ...
        if (!TimeSeriesData.class.isAssignableFrom(obj.getClass())) {
            return false;
        }
        return StringUtils.equalsIgnoreCase(((TimeSeriesData) obj).getCdid(), getCdid());
    }
